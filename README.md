...
generate RAW
```
./waf --run "RAW-generate --NRawSta=128 --NGroup=32 --NumSlot=1 --RAWConfigPath='./OptimalRawGroup/RawConfig-rca-contention-2' --beaconinterval=1000000 --pageSliceCount=2 --pageSliceLen=1"
```
run the simulation
```
