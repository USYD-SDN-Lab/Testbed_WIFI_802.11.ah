...
# AMRR
CXXFLAGS="-std=c++11 -D__SDN_LAB_RA_AMRR -D__SDN_LAB_PROJECTNAME='\"Vincent_Scenario_Static_Contention_04\"'" ./waf configure --disable-examples --disable-tests
# AARF
CXXFLAGS="-std=c++11 -D__SDN_LAB_RA_AARF -D__SDN_LAB_PROJECTNAME='\"Vincent_Scenario_Static_Contention_04\"'" ./waf configure --disable-examples --disable-tests
# Minstrel - P10
CXXFLAGS="-std=c++11 -D__SDN_LAB_RA_MINSTREL -D__SDN_LAB_PROJECTNAME='\"Vincent_Scenario_Static_Contention_04\"'" ./waf configure --disable-examples --disable-tests
# Minstrel - P25
CXXFLAGS="-std=c++11 -D__SDN_LAB_RA_MINSTREL -D__SDN_LAB_RA_MINSTREL_LOOK_AROUND_RATE=25 -D__SDN_LAB_PROJECTNAME='\"Vincent_Scenario_Static_Contention_04\"'" ./waf configure --disable-examples --disable-tests
# Minstrel-SNN (Vincent)
CXXFLAGS="-std=c++11 -D__SDN_LAB_RA_MINSTREL_SNN_VINCENT -D__SDN_LAB_RA_MINSTREL_LOOK_AROUND_RATE=25 -D__SDN_LAB_PROJECTNAME='\"Vincent_Scenario_Static_Contention_04\"'" ./waf configure --disable-examples --disable-tests
