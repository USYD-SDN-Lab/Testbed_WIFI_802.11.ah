...
# static - 0 contention
projectname = "vincent_scenario_contention_0";
# optimal rate
...
#do
#./waf --run "rca --seed=5 --DataMode=$mcs --simulationTime=110 --payloadSize=100 --BeaconInterval=500000 --rho=250 --pagePeriod=4 --pageSliceLength=4 --pageSliceCount=4 --RAWConfigFile='./Components/Settings-Vincent-128-Contention-0-RawConfig.txt' --TrafficPath='./Components/Settings-Vincent-128-Traffic.text'"
#done
...
# 2 contention
#./waf --run "rca --seed=1 --simulationTime=110 --payloadSize=100 --BeaconInterval=500000 --rho=250 --pagePeriod=4 --pageSliceLength=4 --pageSliceCount=4 --RAWConfigFile='./Components/Settings-Vincent-128-Contention-0-RawConfig.txt' --TrafficPath='./Components/Settings-Vincent-128-Traffic.text'"
# 4 contetion
#./waf --run "rca --seed=1 --simulationTime=110 --payloadSize=100 --BeaconInterval=500000 --rho=250 --pagePeriod=4 --pageSliceLength=4 --pageSliceCount=4 --RAWConfigFile='./Components/Settings-Vincent-128-Contention-0-RawConfig.txt' --TrafficPath='./Components/Settings-Vincent-128-Traffic.text'"
# 16 contention
#./waf --run "rca --seed=1 --simulationTime=110 --payloadSize=100 --BeaconInterval=500000 --rho=250 --pagePeriod=4 --pageSliceLength=4 --pageSliceCount=4 --RAWConfigFile='./Components/Settings-Vincent-128-Contention-0-RawConfig.txt' --TrafficPath='./Components/Settings-Vincent-128-Traffic.text'"
